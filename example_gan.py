...
def model_discriminator(input_shape, output_dim=1, hidden_dim=256, activation="tanh", reg=lambda: l1l2(1e-3, 1e-3)):
    return Sequential([
...
if __name__ == "__main__":
    ...
    history = model.fit(x=xtrain, y=y, validation_data=(xtest, ytest), callbacks=[generator_cb], nb_epoch=50, batch_size=32)
